...
<ComponentPreview>
  <Post
    ...
    content="Excited to announce our summer meetup! 🌞 Save the date and check out the details. @bob can't wait to see you there!"
    reactions={["🎉", "👀", "❤️", "🔥"]}
    event={{
...
<ComponentPreview>
  <Comment
    author="bob"
    content="@event_organizer I'll definitely be there! Is there parking available nearby?"
    depth={0}
    timestamp="2 hours ago"
  />
  <Comment
    author="event_organizer"
    content="@bob yes! There's a parking lot right next to the pavilion"
    depth={1}
    reactions={["👍"]}
    timestamp="1 hour ago"
  />
  <Comment
    author="sarah_m"
    content="@event_organizer can I bring a guest?"
    depth={2}
...
<ComponentPreview>
  <Post
    ...
    content="Golden hour at the beach 🌅 One of my favorite shots from this weekend. @charlie the colors are incredible!"
    reactions={["❤️", "📸", "✨", "🔥"]}
...
<Post
  author="admin"
  content="Important: We're rolling out new community features next week! Stay tuned for updates. @everyone"
  reactions={["📢", "👍", "❤️", "🎉"]}
  commentCount={12}
/>
<Post
  author="developer_jane"
  content="Just shipped my first open source project! 🎉 Built with TypeScript and Svelte. Would love to hear your feedback @community"
  reactions={["🚀", "🔥", "👏", "💯"]}
  commentCount={8}
...
<Comment
  ...
  content="@developer_jane This looks fantastic! How did you handle state management?"
  depth={0}
  reactions={["👍", "🤔"]}
  timestamp="3 hours ago"
/>
<Comment
  author="developer_jane"
  content="@tech_enthusiast Thanks! I used Svelte contexts for global state and local state for components"
  depth={1}
  timestamp="2 hours ago"
/>
<Comment
  author="tech_enthusiast"
  content="@developer_jane interesting choice! Did you consider using Zustand or Redux?"
  depth={2}
  timestamp="2 hours ago"
/>
<Comment
  author="developer_jane"
  content="@tech_enthusiast I wanted to keep dependencies minimal for v1. Might revisit for v2!"
  depth={3}
  reactions={["💯", "✅"]}
  timestamp="1 hour ago"
/>
<Comment
  author="senior_dev"
  content="Great work @developer_jane! The code looks clean and well-documented 🎯"
  depth={0}
  reactions={["🚀", "❤️"]}
  timestamp="1 hour ago"
/>
<Comment
  ...
  content="@developer_jane what testing framework did you use?"
  depth={1}
  timestamp="30 minutes ago"
/>
</ComponentPreview>
