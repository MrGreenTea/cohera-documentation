...
Cohera is designed as a library of loosely coupled modules that developers compose to build community platforms. [Each module](/reference/modules) bundles its frontend, backend, and data layers while maintaining independence between these layers.
