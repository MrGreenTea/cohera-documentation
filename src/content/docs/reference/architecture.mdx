...
- **Community first**: Foster community first, let the rest follow
- **Loosely coupled**: Expose clean APIs for independent use
- **Independent layers**: Allow selective use of frontend, backend, or data layers
- **Fully featured**: Cover the common use case out of the box
- **Coherently integrated**: Make modules work together seamlessly
- **Type safety**: Provide end-to-end type safety
- **Monolithic**: Optimize for simple deployment
- **Fine-tuned DX**: Delight developers with a well-crafted experience
- **No magic**: Keep everything transparent and easy to reason about
- **Imperative Shell, Functional Core**: Separate side effects from core logic
- **Federation ready**: Offer federation for every module
