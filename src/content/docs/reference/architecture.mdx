...
- **Community first**: Foster community first, everything else comes second
- **Loosely coupled**: Expose clean APIs for independent use
- **Independent layers**: Provide the freedom to only use
- **Fully featured**: Provide everything for the common use case
- **Coherently integrated**: Integrate modules with each other
- **Type safety**: End-to-end type safety
- **Monolithic**: Optimize for simple deployment
- **Fine-tuned DX**: Delight the developer
- **No magic**: Everything is transparently set up and easy to reason about
- **Imperative Shell, Functional Core**: Separate logic from side-effects
- **Federation ready**: Optional federation for every module
